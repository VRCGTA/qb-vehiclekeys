...
Config.PoliceAlertChance = 0.8 -- Chance of alerting police during the day
Config.PoliceNightAlertChance = 0.6 -- Chance of alerting police at night (times:01-06)
